...
const WEB_SOCKET_SERVER_URL: String = 'wss://typescript-websockets-lobby.jonandrewdavis.workers.dev'
const WEB_SOCKET_SECRET_KEY: String = "9317e4d6-83b3-4188-94c4-353a2798d3c1"
...
var STUN_TURN_SERVER_URLS: Array[Variant] = ['stun:stun.cloudflare.com']
...
var ws_connection_validated: bool = false

var current_username: String = ''
var turn_server_enabled: bool = false
var host = null
...
func _ws_parse_packet():
	var packet: String = ws_peer.get_packet().get_string_from_utf8()
...
func _offerCreated(type, data, id: int) -> void:
...
var should_cancel_connections: bool = false

func _listen_for_connections_finished(lobby) -> void:
...
func generate_random_name() -> String:
	...
	var r1: int = randi_range(0, Emi1.size() - 1)
	var r2: int = randi_range(0, Emi2.size() - 1)
	var r3: int = randi_range(0, Emi3.size() - 1)
